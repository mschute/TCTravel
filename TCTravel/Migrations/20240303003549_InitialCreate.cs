        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientCompanyAddress = table.Column<string>(type: "text", nullable: false),
                    ClientCompanyEmail = table.Column<string>(type: "text", nullable: false),
                    ClientCompanyPhone = table.Column<string>(type: "text", nullable: false),
                    ContactName = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCompanies", x => x.ClientCompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dob = table.Column<DateOnly>(type: "date", nullable: true),
                    DrivingLicenseNo = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxLoadKg = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_ClientCompanies_ClientCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingLocations", x => new { x.BookingId, x.LocationId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingLocations_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingLocations_LocationId",
                table: "BookingLocations",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ClientCompanyId",
                table: "Bookings",
